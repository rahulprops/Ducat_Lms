...
const About = () => {
  return (
    <div className="antialiased dark:bg-gray-100 dark:text-gray-800">
					...
					<div className="fixed right-0 z-10 w-full h-full duration-300 ease-in-out transform translate-x-full top-24">
						...
						<nav className="fixed h-full mt-8">
							<div className="px-12 py-4">
								<a rel="noopener noreferrer" href="#" className="text-2xl font-bold tracking-widest dark:text-gray-50">Blog</a>
							</div>
							<div className="px-12 py-4">
								<a rel="noopener noreferrer" href="#" className="text-2xl font-bold tracking-widest dark:text-gray-50">Tags</a>
							</div>
							<div className="px-12 py-4">
								<a rel="noopener noreferrer" href="#" className="text-2xl font-bold tracking-widest dark:text-gray-50">Projects</a>
							</div>
							<div className="px-12 py-4">
								<a rel="noopener noreferrer" href="#" className="text-2xl font-bold tracking-widest dark:text-gray-50">About</a>
							</div>
						</nav>
					</div>
				</div>
				...
				<ul className="space-y-8 xl:space-y-10">
						...
						<article>
							...
							<div className="space-y-1">
								...
								<div className="flex flex-wrap space-x-3">
									<a rel="noopener noreferrer" href="#" className="text-xs dark:text-violet-600">#angular</a>
									<a rel="noopener noreferrer" href="#" className="text-xs dark:text-violet-600">#tailwind</a>
									<a rel="noopener noreferrer" href="#" className="text-xs dark:text-violet-600">#webdev</a>
								</div>
							</div>
						</article>
					</li>
					<li>
						<article>
							...
							<div className="space-y-1">
								<h3 className="text-2xl font-bold tracking-tight">
									<a rel="noopener noreferrer" href="#" className="dark:text-gray-900"> Vis te oporteat deterruisset.</a>
								</h3>
					...
					<li>
						<article>
							...
							<div className="space-y-1">
								<h3 className="text-2xl font-bold tracking-tight">
									<a rel="noopener noreferrer" href="#" className="dark:text-gray-900">Mentitum apeirian vim ne, usu illud ridens cu.</a>
								</h3>
								<p className="max-w-full dark:text-gray-800 prose prose-invert">Duo ei paulo decore periculis, sed ex hinc inermis vivendo, meis feugait no mea. Pri magna commodo urbanitas cu, id eos lorem inimicus prodesset. Cu qui vidisse epicurei accusamus.</p>
								<div className="flex flex-wrap space-x-3">
									<a rel="noopener noreferrer" href="#" className="text-xs dark:text-violet-600">#angular</a>
									<a rel="noopener noreferrer" href="#" className="text-xs dark:text-violet-600">#tailwind</a>
									<a rel="noopener noreferrer" href="#" className="text-xs dark:text-violet-600">#webdev</a>
